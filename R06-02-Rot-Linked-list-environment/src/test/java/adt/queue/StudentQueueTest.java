...
public class StudentQueueTest {
	...
	public void testEnqueueComErro() throws QueueOverflowException {
		queue1.enqueue(new Integer(4)); // vai depender do tamanho que a fila
	...
	public void testDequeueComErro() throws QueueUnderflowException {
		...
		assertEquals(new Integer(0), queue1.dequeue()); // vai depender do
		// tamanho que a fial
		// foi iniciada!!!
	}
	...
	@Test
	public void queue0() {
		QueueDoubleLinkedListImpl<Integer> queue0 = new QueueDoubleLinkedListImpl<>(0);
		assertEquals(queue0.isEmpty(), queue0.isFull());
	}
}